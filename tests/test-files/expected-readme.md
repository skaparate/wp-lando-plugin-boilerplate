...
```
git clone project-repository my-amazing-plugin
```
...
After installing lando you already have a running WordPress instance, so you can go to my-amazing-plugin.lndo.site (/wp-admin) and see it working.
